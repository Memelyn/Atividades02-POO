 ...
 * @author Jorginho
 */
@WebServlet(name = "ApiMelissaServlet", urlPatterns = {"/Melissa.json"})
public class ApiMelissaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            obj.append("RA",  "63784478");
            obj.append("Nome",  "Melissa");
